...
function hungryDog(weight, age) {
  if (age < 1) {
    if (age >= 0.583) {
      // can't use 7 / 12 because of how the test is written
      return 0.04 * weight
    } else if (age >= 4 / 12) {
      return 0.05 * weight
    } else if (age >= 2 / 12) {
...
function annoyingSong(start) {
  return `${start} bottles of soda on the wall, ${start} bottles of soda, take one down pass it around ${
    start - 1
...
console.log(vowelCounter('Hello there how are you?'))
